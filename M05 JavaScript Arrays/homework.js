...
function arrayContiene(array, elemento) {
   ...
   // Tu código:
   var encontrados = array.find ((e) => e == elemento)
...
function agregarNumeros(arrayOfNums) {
   ...
   // Tu código:
   var result = arrayOfNums.reduce ( (a,b) => a + b , 0)
   return result
}
...
function empiezaConNueve(num) {
   ...
   let primerdigito = texto.charAt(0);
...
function mayorACien(array) {
   ...
   let mayoresQue100 = [];
   for (let i = 0; i < array.length; i++) {
      if (array[i] > 100) mayoresQue100.push(array[i]);
   }
